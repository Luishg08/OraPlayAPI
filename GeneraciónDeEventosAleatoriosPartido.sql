...
VALUES (0,0, '2024-12-20 21:00:00', '2024-12-21 00:00:00', 'N', 'PENDIENTE', 0,0, 0, 1, 2, 2, 1);
...
select * from evento;
SELECT * FROM APUESTAEVENTO;
INSERT INTO APUESTAEVENTO (CANTIDADAPOSTADA, POSIBLEGANANCIA, USUARIOID, PARTIDOID, EQUIPOID, NOMBREEVENTO)
VALUES (30000, 50000, 1, 9, 4, 'TARJETA ROJA');
...
INSERT INTO METODOPAGO (NOMBREMETODO, NUMEROCUENTA, USUARIOID)
VALUES ('DEBITO', 07000004222, 1);
